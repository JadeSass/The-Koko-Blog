            ...
            <div class="col s12 m12 l6 xl6">
                <div class="fm-mgt">
                    ...
                    <div class="form-header">
                            <h5 class="black-text center-align center">Update Post: {{ $post->title}}</h5>
                        </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="input-wrapper col s12 m6 l12 xl12">
                                        <div class="input-field">
                                            <textarea name="content" style="height: 15vh;" id="content" class="validate materialize-textarea">{{ $post->content }}</textarea>
